...
NOT_FOOTPRINTS = {
    ...
    # Rev B removals. These positions existed on the 41.6 x 39.4 mm draft and were
    # removed in the 45 x 46 mm relayout. The prose below still names them in places,
    # so they are listed here rather than left to look like hardware that should be
    # there: a reader who finds `P51` in BUILD.md must be able to see that it is not
    # a pad any more, and where the function moved to.
