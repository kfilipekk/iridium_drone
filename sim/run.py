...
ngspice is not on this machine as a binary, but KiCad ships libngspice.so.0 for its own
built-in simulator. Driving that directly avoids asking anyone to install a package.
"""
import ctypes
import sys
